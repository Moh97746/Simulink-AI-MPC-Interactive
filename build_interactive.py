...
<head>
    ...
    <style>
        ...
        body.dark #sidebar {{ background: #1E293B; box-shadow: -2px 0 10px rgba(0,0,0,0.4); }}
        body.dark #sidebar h1 {{ color: #F1F5F9; border-color: #334155; }}
        body.dark #info-title {{ color: #60A5FA; }}
        body.dark #info-text {{ color: #94A3B8; }}
        body.dark .placeholder {{ color: #64748B; }}
        body.dark #main-content {{ background: #0F172A; }}
        body.dark .header-bar {{ background: #1E293B; border-color: #334155; }}
        body.dark .tab {{ color: #94A3B8; }}
        body.dark .tab:hover {{ color: #60A5FA; }}
        body.dark .tab.active {{ color: #60A5FA; border-color: #60A5FA; }}
        body.dark .btn-ctrl {{ background: #334155; color: #E2E8F0; border-color: #475569; }}
        body.dark .btn-ctrl:hover {{ background: #475569; }}
        body.dark .ctrl-panel {{ background: #1E293B; border-color: #334155; }}
        body.dark .ctrl-panel label {{ color: #CBD5E1; }}
        body.dark svg {{ background: #1E293B; box-shadow: 0 10px 25px rgba(0,0,0,0.3); }}
    </style>
</head>
<body>
    <div id="main-content">
            ...
            <div style="position: relative; margin-left: 15px; display: flex; align-items: center;">
                ...
                <div id="ctrl-panel" class="ctrl-panel">
                    ...
                    <div style="font-size: 11px; color: #94A3B8; text-align: center; line-height: 1.8;">
                        ...
                        <a href="mailto:izzeldeenm@gmail.com" style="color: #3B82F6; text-decoration: none;">izzeldeenm@gmail.com</a>
                    </div>
                </div>
            </div>
